...
// myBlog Routes
$app->route->add('/', 'myBlog/Home'); // Home Page
$app->route->add('/category/:text/:id', 'myBlog/Category');
$app->route->add('/post/:text/:id', 'myBlog/Post');
$app->route->add('/post/:text/:id/add-comment', 'myBlog/Post@addComment', 'POST');
$app->route->add('/register', 'myBlog/Register');
$app->route->add('/register/submit', 'myBlog/Register@submit', 'POST');
$app->route->add('/login', 'myBlog/Login');
$app->route->add('/login/submit', 'myBlog/Login@submit', 'POST');
$app->route->add('/logout', 'myBlog/Logout');
//$app->route->add('/contact-us', 'myBlog/Contact');
//$app->route->add('/contact-us/submit', 'myBlog/Contact@submit', 'POST');
//$app->route->add('/about-us', 'myBlog/About');
//$app->route->add('/profile', 'myBlog/Profile');
//$app->route->add('/search', 'myBlog/Search');
