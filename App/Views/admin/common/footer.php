...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
        <form action="<?= url('/admin/profile/update'); ?>" class="form-modal form">
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="text" name="birthday" placeholder="Birth Day" class="form-control" value="<?= $user->birthday; ?>" />
        </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <select class="form-control" id="gender" name="gender">
                ...
                <option value="female" <?= $user->gender == 'female' ? 'selected': false; ?>>Female</option>
            </select>
        </div>
        ...
        <?php if ($user->image) { ?>
        <div class="form-group col-sm-6">
            <img src="<?= assets('images/' . $user->image); ?>" style="width:50px; height: 50px;" alt="" />
        </div>
        <?php } ?>
